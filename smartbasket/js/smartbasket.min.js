    ...
    (t = function (t) {
      var a = function (a, e, s) {
        var r = {
          ...
          _calculateCaretPosition: function (t) {
            var e = r.getMasked(),
              s = r.getCaret();
            if (t !== e) {
          ...
          get calculateCaretPosition_2() {
            return this._calculateCaretPosition;
          },
          set calculateCaretPosition_2(value) {
            this._calculateCaretPosition = value;
          },
          get calculateCaretPosition_1() {
            return this._calculateCaretPosition;
          },
          set calculateCaretPosition_1(value) {
            this._calculateCaretPosition = value;
          },
          get calculateCaretPosition() {
            return this._calculateCaretPosition;
          },
          set calculateCaretPosition(value) {
            this._calculateCaretPosition = value;
          },
          _behaviour: function (e) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    (t = jQuery),
      ...
      (e = {
        ...
        get deleteProducts() {
          return this._deleteProducts;
        },
        set deleteProducts(value) {
          this._deleteProducts = value;
        },
        ...
        get stateBasket_1() {
          return this._stateBasket;
        },
        set stateBasket_1(value) {
          this._stateBasket = value;
        },
        get stateBasket() {
          return this._stateBasket;
        },
        set stateBasket(value) {
          this._stateBasket = value;
        },
        _commonResult: function (e, s, r) {
          let n = 0,
            i = 0,
            o = t("<div>")
        ...
        get commonResult() {
          return this._commonResult;
        },
        set commonResult(value) {
          this._commonResult = value;
        },
        _getSmartBasketMinState: function (s, r) {
          let n = 0;
          for (let t in s)
        ...
        get getSmartBasketMinState() {
          return this._getSmartBasketMinState;
        },
        set getSmartBasketMinState(value) {
          this._getSmartBasketMinState = value;
        },
        ...
        _userForm: function () {
          let s = t("<div>").attr({ class: "smart-basket__user-form" }),
            r = t("<div>").attr({
              _class: "smart-basket__user-info",
              get class() {
                return this._class;
              },
              set class(value) {
          ...
          let c = t("<div>").attr({ class: "smart-basket__input-wrapper" }),
            p = t("<input>").attr({
              _class_1: "smart-basket__user-input",
              get class() {
                return this._class_1;
              },
              set class(value) {
                this._class_1 = value;
              },
          ...
          if ((c.append(p), a.agreement.isRequired)) {
            ...
            (r = a.agreement.isLink
              ? t("<a>").attr({
                  _class: "smart-basket__link-agreement",
                  get class() {
                    return this._class;
                  },
                  set class(value) {
        ...
        set userForm_2(value) {
          this._userForm = value;
        },
        get userForm_1() {
          return this._userForm;
        },
        set userForm_1(value) {
          this._userForm = value;
        },
        get userForm() {
          return this._userForm;
